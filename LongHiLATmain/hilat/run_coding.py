...
#     # sweep_id = wandb.sweep(sweep_config, project='Long-HiLAT_5')
...
# Will error if the minimal version of Transformers is not installed. Remove at your own risks.
from LongHiLATmain.hilat.models.modeling import CodingModel, CodingModelConfig
from LongHiLATmain.hilat.models.utils import initial_code_title_vectors, calculate_scores, tokenize_dataset, MimicIIIDataset, \
    segment_tokenize_dataset, LazyMimicIIIDataset
...
def main():
    ...
    model.save_pretrained("Long-HiLAT_5")
