...
from text_segmenter import segment_ds
...
flags.DEFINE_string("postgres", default="dbname=mimic user=postgres password=Megh@1996",
                    help="connection string: dbname=test user=postgres password=secret")
flags.DEFINE_string("postgres_schema", default="mimiciii", help="Postgres database schema")
flags.DEFINE_string("mimic_iii_hadm_ids_file_dir", default="C:/Users/mkanneganti/Downloads/ICD_Coding/LAAT-master/data/mimicdata/mimic3", help="directory of Hadm ids files for datasets")
flags.DEFINE_string("data_output_dir", default="",
...
def main(argv):
    ...
    #         outdir=str(Path(FLAGS.data_output_dir) / "5"),
    #         top_n_labels=top_n_labels)
    #     logging.info("Raw data saved into folder %s", Path(FLAGS.data_output_dir) / "5")
    # else:
    ...
    segment_ds(Path(FLAGS.data_output_dir) / "5", FLAGS, logging, "5")
