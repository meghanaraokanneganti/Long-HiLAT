...
# load label dict
label_dict = pd.read_csv('C:/Users/mkanneganti/Downloads/ICD_Coding/HiLAT-main/data/attention/labels_dictionary_5_level_1.csv')
# code_list = label_dict['icd9_code'].tolist()

# read raw data
with open('C:/Users/mkanneganti/Downloads/ICD_Coding/HiLAT-main/data/attention/test_data_5_level_1_seq-512.pkl', 'rb') as f:
    test_data = pickle.load(f)

# read prediction results
with open('C:/Users/mkanneganti/Downloads/ICD_Coding/HiLAT-main/data/attention/predict_results_mimic3-50.pkl', 'rb') as f:
...
def display_attention(data, results, code_dict, tokenizer, record_no):
    ...
    print(f"Size of results['predictions']: {len(results['predictions'])}")
    ...
    for i in range(len(true_labels)):
        print(true_labels[i])
        print("i is"+ i)
        if true_labels[i] == 1.0 and pred_labels[i] == 1.0:
            # code i
